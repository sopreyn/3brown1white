...
export const SWING_DURATION = 0.20; // seconds the bat hitbox is active
export const SWING_COOLDOWN = 0.30; // seconds before another swing can start
export const SWING_RANGE = 20; // extra reach in front of the player
export const SWING_RANGE_UPGRADED = 30;

export const HURT_IFRAMES = 1.1; // seconds of flicker/invulnerability after being hit
export const INVINCIBLE_TIME = 7; // seconds of star-power from a golden bug

export const KNOCKBACK_VX = 70;
